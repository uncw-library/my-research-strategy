        ...
        <Card style={styles.card}>
          <CardContent>
            <Typography gutterBottom variant="subheading" component="h2" align="left"
              style={{ marginTop: 15, marginBottom: -15 }}><label for={`keyword_${this.props.data.id}`}>2. Keyword:</label></Typography>
            <TextField
            ...
            <Typography gutterBottom variant="subheading" component="h2" align="left"
              style={{ marginTop: 15, marginBottom: -15 }}><label for={`synonym1_${this.props.data.id}`} >3. Related terms:</label></Typography>
            <TextField
            ...
            />
            <Typography gutterBottom variant="subheading" component="h2" align="left"
              style={{ marginTop: 15, marginBottom: -15 }}><label for={`synonym2_${this.props.data.id}`} >Related terms:</label></Typography>
            <TextField
