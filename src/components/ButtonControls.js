      ...
      return (
         <Grid container>
            <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
               <Button color={(this.props.activeView === "createQuestion") ? "default" : "primary"} variant="contained" style={styles.button}
               ...
               <Button color={(this.props.activeView === "identifyConcepts") ? "default" : "primary"} variant="contained" style={styles.button}
               ...
               <Button color={(this.props.activeView === "findTerms") ? "default" : "primary"} variant="contained" style={styles.button}
                  disabled={!this.props.query ? true : false}
                  onClick={(e) => this.props.updateActiveView('findTerms')}>3. Find Related Terms</Button>

               <Icon style={{ fontSize: 60, fontWeight: 'bold', marginBottom: -25 }}>arrow_forward</Icon>

               <Button color={(this.props.activeView === "search") ? "default" : "primary"} variant="contained" style={styles.button}
                  disabled={!this.props.query ? true : false}
                  onClick={(e) => this.props.updateActiveView('search')}>4. Search</Button>

               <Button color="primary" variant="contained" style={styles.button} onClick={(e) => this.props.startOver()}>Start Over</Button>
